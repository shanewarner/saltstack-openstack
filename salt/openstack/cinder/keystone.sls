...
keystone_cinderv2_endpoint:
  keystone.endpoint_present:
    - name: cinderv2
    - publicurl: http://{{ salt["pillar.get"]("cinder:public_ip") }}:8776/v2/%(tenant_id)s
    - internalurl: http://{{ salt["pillar.get"]("cinder:internal_ip") }}:8776/v2/%(tenant_id)s
    - adminurl: http://{{ salt["pillar.get"]("cinder:admin_ip") }}:8776/v2/%(tenant_id)s
